...
//int var1;
            if ((colony.getHiveId()!= dbConnection.thereIsColonyWithThisHiveNr(colony)) &&
                (colony.getHiveId()== dbConnection.isThereHiveWithThisNr(hive,colony) ))
            {
                System.out.println("There is not colony in this hive");
            }
            else if (colony.getHiveId()!= dbConnection.isThereHiveWithThisNr(hive,colony)){

//            var1=1;
                System.out.println("There is not hive with this number");}
        }
...
//        colony.setHiveId(methods.validatorForIntegers(scanner));
        ...
        dbConnection.addRecordToHistory(history);
 //        PRINT OUT IN CONSOLE
        System.out.println("Added pollen " + colony.getPollen() + " in hive nr. " + colony.getHiveId());
    }
    //ADD KG OF HONEY
...
//        colony.setHiveId(methods.validatorForIntegers(scanner));
        ...
        // ADD TO HISTORY
        history.setActionDone("Added queen's year: " + colony.getQueenYear()+ " i hive nr. " + colony.getHiveId());
        history.setDataAndTime(localDateTime.format(dateTimeFormatter));
//        PRINT OUT IN CONSOLE
...
//        colony.setHiveId(methods.validatorForIntegers(scanner));
        ...
        dbConnection.addRecordToHistory(history);
//        PRINT OUT IN CONSOLE
        System.out.println("Added queen breed " + colony.getQueenBreed() + " in hive nr. " + colony.getHiveId());
    }
    //ADD COLONY ORIGIN
...
//        colony.setHiveId(methods.validatorForIntegers(scanner));
        ...
        dbConnection.addRecordToHistory(history);
        //        PRINT OUT IN CONSOLE
        System.out.println("Added colony origin " + colony.getColonyOrigin() + " in hive nr. " + colony.getHiveId());
    }
